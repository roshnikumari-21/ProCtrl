      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl font-black text-white mt-2">
                {candidate ? `Welcome, ${candidate.name || "Candidate"}` : "Welcome"}
              </h1>
        ...
        <Card className="p-6 bg-slate-900 border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.3em] text-slate-500">Start</p>
          ...
          <Button fullWidth size="lg" className="h-12 font-black" onClick={handleJoinTest}>
            Go to Join Test
          </Button>
        </Card>
        ...
        <Card className="p-6 bg-slate-900 border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.3em] text-slate-500">History</p>
          ...
          <Button fullWidth size="lg" variant="ghost" className="h-12 font-black border border-amber-500/50 text-amber-200 hover:bg-amber-500/10" onClick={handleViewScores}>
            View Past Scores
          </Button>
        </Card>

        <Card className="lg:col-span-3 p-6 bg-slate-900 border border-slate-800 shadow-xl">
          <h3 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-4">Session Tips</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-slate-300">
            {["Keep your ID ready for verification.", "Use a quiet, well-lit environment.", "Stay on this tab during the exam."].map((tip, idx) => (
